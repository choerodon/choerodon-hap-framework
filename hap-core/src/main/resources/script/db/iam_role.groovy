...
databaseChangeLog(logicalFilePath: 'script/db/iam_role.groovy') {
    changeSet(author: 'jcalaz@163.com', id: '2018-03-21-iam-role') {
        ...
        createTable(tableName: "IAM_ROLE") {
            ...
            column(name: 'RESOURCE_LEVEL', type: 'VARCHAR(32)', remarks: '角色层级site/organization/project')
        ...
        addUniqueConstraint(tableName: 'IAM_ROLE', columnNames: 'CODE', constraintName: 'UK_IAM_ROLE_U1')
