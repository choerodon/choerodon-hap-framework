...
import io.choerodon.hap.attachment.service.ISysAttachmentService;
 ...
 */
@Service
@Dataset("mailAttachment")
@Transactional(rollbackFor = Exception.class)
public class SysAttachmentServiceImpl extends BaseServiceImpl<SysFile> implements ISysAttachmentService, IDatasetService<SysFile> {
    @Autowired
    ...
    public List<?> queries(Map<String, Object> body, int page, int pageSize, String sortname, boolean isDesc) {
        try {
            SysFile sysFile = objectMapper.readValue(objectMapper.writeValueAsString(body), SysFile.class);
            return this.selectFiles(null, sysFile, page, pageSize);
        } catch (IOException e) {
