...
@Service
@Dataset("PermissionRuleDetailUser")
public class DataPermissionRuleDetailUserServiceImpl implements IDatasetService<DataPermissionRuleDetail> {
    ...
    public List<?> queries(Map<String, Object> body, int page, int pageSize, String sortname, boolean isDesc) {
        ...
        return datasetMapper.selectRuleDetailUser(body);
    }
