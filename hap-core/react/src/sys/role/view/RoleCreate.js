...
import { axiosPro as axios, ContentPro as Content, Header, Page } from '@choerodon/boot';
import RoleStore from '../stores/RoleStore';
import MouseOverWrapper from '../../../components/mouseOverWrapper';
import { handleFiltersParams } from '../../../common/util/util';
import '../Role.scss';
...
export default class CreateRole extends Component {
  ...
  setCanPermissionCanSee() {
    ...
    for (let c = 0; c < levels.length; c += 1) {
      ...
      Observable.fromPromise(axios.get(`/v1/permissions?level=${levels[c]}`))
        .subscribe((data) => {
