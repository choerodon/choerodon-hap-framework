 ...
 * @author xiaohua
 */
public interface ISysFileService extends IBaseService<SysFile>, ProxySelf<ISysFileService> {
     ...
     * @return 文件列表
     */
    List<SysFile> selectFilesByTypeAndKey(IRequest requestContext, String type, String key);
